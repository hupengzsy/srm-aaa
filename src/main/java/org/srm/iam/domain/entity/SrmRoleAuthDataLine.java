...
public class SrmRoleAuthDataLine extends AuditDomain {
    ...
    public SrmRoleAuthDataLine setAuthDataLineId(Long authDataLineId) {
    ...
    public SrmRoleAuthDataLine setAuthDataId(Long authDataId) {
    ...
    public SrmRoleAuthDataLine setTenantId(Long tenantId) {
    ...
    public SrmRoleAuthDataLine setDataId(Long dataId) {
        this.dataId = dataId;
        return this;
    }
    ...
    public SrmRoleAuthDataLine setDataCode(String dataCode) {
    ...
    public SrmRoleAuthDataLine setDataName(String dataName) {
    ...
    public SrmRoleAuthDataLine setTenantName(String tenantName) {
