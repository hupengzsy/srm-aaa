...
public class AutoAssignTenantAdminRoleAndDataPrivServiceImpl
    ...
    @Autowired
    private UserAuthorityMapperLineData userAuthorityMapper;
    @Autowired
    ...
    protected List<Role> getAdminRoleInheritTemplateList(TenantAdminRoleAndDataPrivAutoAssignmentDTO tenantAdminRoleAndDataPrivAutoAssignmentDTO) {
        ...
        // 获取模板角色实体
        List<Role> adminRoleInheritTemplateList = new ArrayList<>();
...
//            memberRoleService.batchDeleteMemberRole(tenant.getTenantId(), memberRoleList);
        } catch (Exception ex) {
